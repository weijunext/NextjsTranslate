...
<Image
  alt="路由段到路径段"
  src="https://nextjs.org/_next/image?url=%2Fdocs%2Flight%2Ftop-level-folders.png&w=3840&q=75"
  srclight="https://nextjs.org/_next/image?url=%2Fdocs%2Flight%2Ftop-level-folders.png&w=3840&q=75"
  srcdark="https://nextjs.org/_next/image?url=%2Fdocs%2Fdark%2Ftop-level-folders.png&w=3840&q=75"
  width="1600"
  height="525"
/>
...
以下文件约定用于在 [`App Router`](/docs/app)中定义路由和处理元数据。
...
以下文件约定用于在 [`Pages Router`](/docs/pages)中定义路由。
